...
namespace Assets.Scripts.Core.Buriko
{
	internal class BurikoMemory
	{
		...
		public BurikoMemory()
		{
			...
			variableReference.Add("GADVMode", 152);
			variableReference.Add("GLinemodeSp", 153);
			variableReference.Add("GCensor", 154);
			variableReference.Add("GEffectExtend", 155);
			variableReference.Add("GAltBGM", 156);
			variableReference.Add("GAltSE", 157);
			variableReference.Add("GAltBGMflow", 158);
			variableReference.Add("GAltSEflow", 159);
			variableReference.Add("GAltVoice", 160);
			variableReference.Add("GAltVoicePriority", 161);
			variableReference.Add("GCensorMaxNum", 162);
			variableReference.Add("GEffectExtendMaxNum", 163);
			variableReference.Add("GAltBGMflowMaxNum", 164);
			variableReference.Add("GAltSEflowMaxNum", 165);
			variableReference.Add("GMOD_SETTING_LOADER", 166);
			variableReference.Add("GFlagForTest1", 167);
			variableReference.Add("GFlagForTest2", 168);
			variableReference.Add("GFlagForTest3", 169);
			variableReference.Add("NVL_in_ADV", 170);
			variableReference.Add("GFlagMonitor", 171);
			variableReference.Add("DisableModHotkey", 172);
			variableReference.Add("GMOD_DEBUG_MODE", 173);
