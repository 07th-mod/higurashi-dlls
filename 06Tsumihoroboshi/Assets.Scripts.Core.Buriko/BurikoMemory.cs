...
namespace Assets.Scripts.Core.Buriko
{
	...
	{
		private Dictionary<string, BurikoMemoryEntry> memorylist;

		private Dictionary<string, int> variableReference;

		private Dictionary<int, int> flags;

		private Dictionary<int, int> globalFlags;

		private Dictionary<string, List<int>> readText;

		private List<string> cgflags;
		...
		public BurikoMemory()
		{
			...
			variableReference = new Dictionary<string, int>();
			flags = new Dictionary<int, int>();
			globalFlags = new Dictionary<int, int>();
			readText = new Dictionary<string, List<int>>();
			cgflags = new List<string>();
			memorylist = new Dictionary<string, BurikoMemoryEntry>();
			...
			variableReference.Add("GADVMode", 101);
			variableReference.Add("GLinemodeSp", 102);
			variableReference.Add("GCensor", 103);
			variableReference.Add("GEffectExtend", 104);
			variableReference.Add("GAltBGM", 105);
			variableReference.Add("GAltSE", 106);
			variableReference.Add("GAltBGMflow", 107);
			variableReference.Add("GAltSEflow", 108);
			variableReference.Add("GAltVoice", 109);
			variableReference.Add("GAltVoicePriority", 110);
			variableReference.Add("GCensorMaxNum", 111);
			variableReference.Add("GEffectExtendMaxNum", 112);
			variableReference.Add("GAltBGMflowMaxNum", 113);
			variableReference.Add("GAltSEflowMaxNum", 114);
			variableReference.Add("GMOD_SETTING_LOADER", 115);
			variableReference.Add("GFlagForTest1", 116);
			variableReference.Add("GFlagForTest2", 117);
			variableReference.Add("GFlagForTest3", 118);
			variableReference.Add("GFlagMonitor", 119);
			variableReference.Add("GMOD_DEBUG_MODE", 120);
			variableReference.Add("GLipSync", 121);
			variableReference.Add("NVL_in_ADV", 122);
			variableReference.Add("DisableModHotkey", 123);
