...
namespace Assets.Scripts.UI
{
	...
	public class MainUIController : MonoBehaviour
	{
		...
		{
			string textureName = (BurikoMemory.Instance.GetGlobalFlag("GADVMode").IntValue() == 1) ? "windo_filter_adv" : "windo_filter";
			if (carretVisible)
			{
				ShowCarret();
			}
		...
		public void OnGUI()
		{
			...
			if (BurikoMemory.Instance.GetGlobalFlag("GFlagMonitor").IntValue() >= 3)
			{
				...
				string text9 = "\n\n[GameStatus]";
				string text10 = (!gameSystem.CanInput) ? "false" : "true";
				string text11 = (!gameSystem.CanSave) ? "false" : "true";
				text9 = text9 + "\nCanInput = " + text10 + "\nCanSave = " + text11;
				str += text9;
