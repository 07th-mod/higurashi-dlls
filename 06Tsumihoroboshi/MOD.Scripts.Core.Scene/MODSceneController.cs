...
namespace MOD.Scripts.Core.Scene
{
	public class MODSceneController
	{
		...
		private static bool[] MODLipSync_Bool = new bool[50];

		private static int[] MODLipSync_Layer = new int[50];

		private static string[] MODLipSync_Texture = new string[50];

		private static int[] MODLipSync_X = new int[50];

		private static int[] MODLipSync_Y = new int[50];

		private static int[] MODLipSync_Z = new int[50];

		private static int[] MODLipSync_Priority = new int[50];

		private static int[] MODLipSync_Type = new int[50];

		public static int[] MODLipSync_Channel = new int[50];

		public static ulong[] MODLipSync_CoroutineId = new ulong[50];
