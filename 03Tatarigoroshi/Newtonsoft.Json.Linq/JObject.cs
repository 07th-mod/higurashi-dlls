...
{
	public class JObject : JContainer, IDictionary<string, JToken>, ICollection<KeyValuePair<string, JToken>>, IEnumerable, IEnumerable<KeyValuePair<string, JToken>>, ICustomTypeDescriptor, INotifyPropertyChanged, Newtonsoft.Json.ObservableSupport.INotifyPropertyChanging
	{
