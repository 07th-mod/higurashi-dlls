...
namespace Assets.Scripts.Core.TextWindow
{
	public class TextController
	{
		...
		public Vector3 GetCarretPosition()
		{
			...
			float x = (float)Mathf.RoundToInt(20f + TextArea.textInfo.lineInfo[TextArea.textInfo.lineCount - 1].lineExtents.max.x) + TextArea.gameObject.transform.localPosition.x;
